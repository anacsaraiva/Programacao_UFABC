/* Implemente uma função recursiva chamada multiplicacao_russa que recebe dois números inteiros e retorne a sua multiplicação. 
Utilize o método de multiplicação à Russa ou multiplicação Etíope. Uma descrição informal do método é:
...
int multiplicacao_russa(int a, int b) {
    ...
    if( a % 2 == 0){
        a /= 2;
        return multiplicacao_russa(a,b*2);
    }else
        a /=2;
        return b + multiplicacao_russa(a, b*2);
